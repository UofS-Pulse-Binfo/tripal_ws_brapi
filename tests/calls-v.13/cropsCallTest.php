...
/**
 * Crops Call (Version 1.3)
 * https://brapi.docs.apiary.io/#reference/crops/crops/**deprecated**-get-crops
 */
class cropsCallTest extends GenericHttpTestCase {

  /**
   * The short name of the call for Assestion messages.
   */
  public $callname = 'crops';

  /**
   * The URL for the call for requests.
   * For example: web-services/brapi/v1/people
   */
  public $url = 'web-services/brapi/v1/crops';
